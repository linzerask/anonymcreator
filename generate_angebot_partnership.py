  ...
  <table class="pricing-matrix">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="col-unit">59,00 &euro; / Monat</td>
        <td class="col-total">59,00 &euro; / Monat</td>
      </tr>
    </tbody>
  </table>
...
# Example usage with placeholder replacement
client_data = {
    "LOGO_BASE_URI": logo_base_uri,
    "ANGEBOTS_NUMMER": "AG-2026-0018",
    "DATUM": "04. Juni 2026",
    "GUELTIG_BIS": "04. Juli 2026",
    "FIRMEN_NAME": "Kaffeemühle",
    "ANSPRECHPARTNER": "Inhaber/in",
    "STRASSE_HAUSNUMMER": "Dauphinestraße 69",
    "PLZ_ORT": "4030 Linz",
    "PROJEKT_TITEL": "Exklusiver Gastronomie-Auftritt & Smartphone-Optimierung"
}
...
filename = f"Angebot_{safe_firma_name}_AnonymCreator_Partnerschaft.pdf"
output_pdf_path = os.path.join(output_dir, filename)

print("Launching headless Chromium engine...")
...
with sync_playwright() as p:
    ...
    print(f"Generating High-End PDF to {output_pdf_path}...")
    page.pdf(
...
print(f"Success! PDF has been generated at: {output_pdf_path}")
